...
AddEventHandler("esx:setJob", function(src, job, lastJob)
	...
	local currentLastJob2 = ESX.JobsPlayerCount[lastJob2.name]  
	local currentJob2 = ESX.JobsPlayerCount[job2.name]  
	
	ESX.JobsPlayerCount[lastJob2.name] = ((currentLastJob2 and currentLastJob2 > 0) and currentLastJob2 or 1) -1
